	...
	\section{Drone Structures}\label{PL:Design:Structures}
		...
		\subsection{Landing Legs}
			...
			\subsection{Arm Configuration}
				...
				\begin{table}[H]
					{\footnotesize
					\caption{Risk Matrix for Retractable Landing Mechanism}
					\centering
					\begin{tabularx}{\linewidth}{XXXlXl}
					\toprule
					Risk & Cause & Impact & RBM & Mitigation & RWM \\ \midrule
					Incomplete landing leg unfolding & Miscalculations of the Parallel Four Bar Linkage dimensions & Instability of the UAV during “ice sample” retrieval and risk of unable to retrieve the desired amount of sample & \cellcolor{orange!25} 3C & 1) Repetitive testing and prototyping of the RLM system 2) Using simple mechanical properties and reduce system complexities & 4D \\
					Horizontal instability & Lack of horizontal constraints and supports at various joints & Potential UAV body tipping and leg failure which leads to mission incompletion & \cellcolor{orange!25} 2C & 1) Creating horizontal support at joints 2) Potential cone shape padding at landing leg roots & 4E \\
					Plastic deformation of legs during landing & Insufficient material strength of legs and shearing caused by moments about joints due to weight & One or multiple landing leg failures which could result in mission incompletion & \cellcolor{green!25} 2E & 1) Ample material testing and research 2) Continuous stress and shear testing in the construction process & 4E \\
					Leg joint failures during flight & Vibrations throughout the rocket during ascent and ejection charge initiation & Possible damage to landing legs and increase in horizontal instabilities & \cellcolor{green!25} 3D & 1) Vibration testing to alleviate the negative effects during ascent 2) Repetitive testing of joint securement system & 4E \\
					\bottomrule
				 \end{tabularx}
				 }
