...
\section{Team-derived requirements}\label{PL:Requirements:Ours}
	...
	\begin{enumerate}[noitemsep, label=\arabic*.]
			...
			\begin{enumerate}[noitemsep, label=3.\arabic*.]
				\item Computer Vision Check
					\begin{enumerate}[noitemsep, label=3.1.\arabic*.]
						\item The computer vision program must be working as designed as the UAV approaches a GPS waypoint for the landing site of the sample material. The pilot will have to manually confirm that the system is functioning properly.
					\end{enumerate}
				\item Ice Retrieval and Mobility Agent System Check
					\begin{enumerate}[noitemsep, label=3.2.\arabic*.]
						\item The Ice Retrieval and Mobility Agent system must confirm its functionality post-deployment.
						\item The flight computer must confirm that the members of the Ice Retrieval and Mobility Agent can close to scoop the material. 
					\end{enumerate}
		...
		\item Sample Retrieval Protocol
			\begin{enumerate}[noitemsep, label=4.\arabic*.]
				\item Engage Ice Retrieval and Mobility Agent 
					\begin{enumerate}[noitemsep, label=4.1.\arabic*.]
						\item The Ice Retrieval and Mobility Agent must close its members around a collection of the sample.
						\item The UAV pilot must confirm that the Ice Retrieval and Mobility Agent has retrieved a sufficient amount of the sample.
					\end{enumerate}
